...
Version: %{version}
Release: %{release}
Source: http://prdownload.berlios.de/jenkryptor/%{name}-%{version}-src.tar.bz2
Vendor: WizTools.org
...
then
	...
	cp src/main/shell/jenkryptor ${RPM_BUILD_ROOT}/usr/bin/
	chmod +x ${RPM_BUILD_ROOT}/usr/bin/jenkryptor
